...
namespace SCW.Migrations
{
    ...
    [Migration("20210321121912_Init3")]
    partial class Init3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SCW.Entities.Material", b =>
                {
                    b.HasOne("SCW.Entities.Subject", null)
                        .WithOne("Material")
                        .HasForeignKey("SCW.Entities.Material", "SubjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SCW.Entities.Subject", b =>
                {
                    b.HasOne("SCW.Entities.FieldOfStudy", null)
                        .WithMany("Subjects")
