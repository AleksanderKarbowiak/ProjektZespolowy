        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Degree = table.Column<string>(maxLength: 15, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceForHour = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    FacultyId = table.Column<int>(nullable: false),
                    LectuerId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FacultyLectuer", x => new { x.FacultyId, x.LectuerId });
                    table.ForeignKey(
                        name: "FK_FacultyLectuer_Faculties_FacultyId",
                        column: x => x.FacultyId,
                        principalTable: "Faculties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FacultyLectuer_Lectuers_LectuerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LectuerSubject", x => new { x.LectuerId, x.SubjectId });
                    table.ForeignKey(
                        name: "FK_LectuerSubject_Lectuers_LectuerId",
                        column: x => x.LectuerId,
                        principalTable: "Lectuers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LectuerSubject_Subjects_SubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubjectTutor", x => new { x.SubjectId, x.TutorId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FacultyLectuer_LectuerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LectuerSubject_SubjectId",
